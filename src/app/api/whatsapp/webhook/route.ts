...
import { getWhatsAppConfig, getDefaultWhatsAppConfig } from '@/lib/integrations/whatsapp/config';
import { updateMessageStatus } from '@/lib/integrations/firebase-legacy';
import { handleIncomingWhatsAppMessage } from '@/lib/integrations/whatsapp/message-handler';
